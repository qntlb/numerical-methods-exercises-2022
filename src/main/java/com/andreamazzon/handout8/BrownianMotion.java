...
public class BrownianMotion {
	 ...
	 * a given time index
	 *
	 * @param timeIndex, index which identifies the time at which the Brownian motion is
	 *                   considered
	 * @return a random variable which stands for the Brownian motion for a given
	 *         factor at a given time index
	 */
	...
	public RandomVariableFromArray getProcessAtGivenTime(double time) {
		...
		/*
		 * We return the closest integer to the value time/timeStepLength: we do
		 * it via the method round of the class Math, which returns a long. For this
		 * reason, we have do cast to int
		 */
