...
import com.andreamazzon.exercises.simulators.StochasticProcessSimulatorInterface;
...
public class DigitalOption implements EuropeanTypeOptionMonteCarlo {
	...
	public double getPrice(StochasticProcessSimulatorInterface underlyingProcess) {
		...
		//return getPayoffWithDoubleStream(underlyingProcess).average().getAsDouble();
